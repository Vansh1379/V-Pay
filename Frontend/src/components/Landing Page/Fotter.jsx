...
const Fotter = () => {
  ...
  return (
    <div className='flex w-[1268px] h-max justify-evenly '>
      <div className=''>
      ...
      <div className=''>
        <div>
          <h3 className='text-base font-medium mt-3 mb-2'>Bussiness Solution</h3>
        </div>
      </div>

      <div className=''>
        <div>
          <h3 className='text-base font-medium mt-3 mb-2'>Insurence</h3>
        </div>
      </div>
