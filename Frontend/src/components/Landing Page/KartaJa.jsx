    ...
    return (
        <div className='mt-6'>
            ...
            <div className='ml-[530px]'>
                <button type="button" className=" w-[200px] border-black text-violet-800 border hover:bg-violet-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-3xl text-sm px-5 py-2.5 me-2 mb-2 ">Watch all videos </button>
            </div>
            ...
            <div className=''>
                <div className='w-[900px] h-[125px] ml-[210px]'>
                    ...
                    <div className='ml-[370px]'>
                        <h3 className='text-violet-800'>#KarteJaBadteJa</h3>
                    </div>
                </div>
            </div>
        </div>
